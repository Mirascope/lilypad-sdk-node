import fs from 'fs';
import type { ResponseLike } from 'lilypad-sdk/internal/to-file';
import { toFile } from 'lilypad-sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('lilypad-sdk/core/uploads');
    await expect(
